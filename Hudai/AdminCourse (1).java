...
public class AdminCourse extends JFrame implements ActionListener
{
	...
	public void submit()
	{
		String query = "INSERT INTO `exam` VALUES ('"+combobox1.getSelectedItem().toString()+"' , '"+combobox2.getSelectedItem().toString()+"', '"+combobox3.getSelectedItem().toString()+"', '"+combobox6.getSelectedItem().toString()+"', '"+combobox7.getSelectedItem().toString()+"', '"+combobox4.getSelectedItem().toString()+"', '"+combobox8.getSelectedItem().toString()+"');";
		System.out.println(query);
        try
		{
